...
/* Private arg type identifiers */
#define POPT_ARG_MAGIC_ALIAS   10
#define POPT_ARG_MAGIC_HELP    11
...
#define POPT_AUTOALIAS { NULL, '\0', POPT_ARG_MAGIC_ALIAS, "", \
			0, "Options implemented via popt alias/exec:", NULL },
...
#define POPT_AUTOHELP { NULL, '\0', POPT_ARG_MAGIC_HELP, "", \
			0, "Help options:", NULL },
